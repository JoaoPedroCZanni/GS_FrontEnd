...
export default function Cadastro() {
    ...
    return(
        <div className="flex flex-col items-center">
            ...
            <button className="text-center text-lg bg-green-600 hover:bg-green-700 text-white font-bold p-3 rounded-lg m-12"><Link href="/cadastro/cadastrar">Adicionar cadastro</Link></button>
