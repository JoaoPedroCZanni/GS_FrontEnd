...
export default function Concluir() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        toast.success("Atividade concluida com sucesso!")
        form.reset()
    }
    ...
    return (
        <div>
            ...
            <section className="m-5 w-full flex justify-center">
                <form onSubmit={handleSubmit} className="flex flex-col w-[80vw] sm:w-[50vw] bg-gray-200 rounded-lg p-5">
                    <fieldset className="border-none flex flex-col">
                        <legend className="p-4 text-2xl font-bold text-center">Coloque as informções da sua evidência de conclusão</legend>
                        <label className="pt-2 pb-2 block">
                            <select name="tipo_evidencia" id="idTipo_evidencia" className="text-lg w-full p-2 rounded-md border-none">
                        ...
                        <label className="pt-2 pb-2 block">
                            <input type="url" name="url_arquivo" id="idUrl_arquivo" placeholder="Insira o link do arquivo" className="text-lg w-full p-2 rounded-md border-none" />
                        </label>
                        <label className="pt-2 pb-2 block">
                            <input type="date" name="data_envio" id="idData_envio" className="text-lg w-full p-2 rounded-md border-none"/>
                        </label>
                        <label className="pt-2 pb-2 block">
                            <select name="status_evidencia" id="idStatus_evidencia" className="text-lg w-full p-2 rounded-md border-none">
                    ...
                    <button type="submit" className="bg-gray-400 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">Enviar</button>
                </form>
            </section>
        </div>
    )
